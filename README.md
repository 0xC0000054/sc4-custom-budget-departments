...
| 0x4252085F  | Budget: Custom Department Name Key | Uint32 | Specifies the name key for a custom budget department. There must be one entry for each custom budget line item. Each entry is a series of 3 Uint32 values, consisting of the department id followed by the group and instance ids of the LTEXT file. |
